...
<div id="wrapper">
  ...
  <section id="main">
    <section class="content">
      <?php query_posts('category_name=concert'); ?>
      ...
      <article class="concert">
        <div class="row">
          <div class="col-sm-4 col-sm-push-8">
            <img class="posterimg frame" src="<?php the_field("ポスター", $post->ID); ?>" width="240" height="320">
          </div>

          <div class="col-sm-8 col-sm-pull-4">
            <dl>
              <dd><?php echo (get_field("end_flag", $post->ID)) ?: the_title()."は終了いたしました。ご来場ありがとうございました。"; ?></dd>
              <dt>指揮</dt>
              ...
              <dt>
                プレイガイド
                <?php echo get_field("guide_flag", $post->ID) ? " (販売は終了しました)" : " (販売中)"; ?>
              </dt> 
