...
$main'mimew_version = "2.02-kentweb-E100";
...
#
# 再配布・改変について : 
#        このライブラリは、KENT WEB ( http://www.kent-web.com/ ) に
#        おいて以下の2点を修正し、再配布を行います。
#        (1) $often_use_kanji = 'SJIS'; とした
#        (2) ライブラリ内ドキュメント部の文字コードをシフトJISに変換
#
